...
type TransmuteObjectProps = {
  ParentMastery: Mastery;
  active: boolean;
  updateSpell: <K extends keyof Spell>(field: K, value: Spell[K]) => void;
};

const TransmuteObject = ({
  ParentMastery,
  active,
  updateSpell,
}: TransmuteObjectProps) => {
  ...
  const baseCost = getCost(ParentMastery.getType(), selectedPotency);
...
export default TransmuteObject;
