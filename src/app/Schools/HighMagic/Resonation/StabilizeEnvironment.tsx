  ...
  return (
    <>
      <div>
        ...
        <br />
        <p>
          Info: Organizes scrambled transmissions in the area. Potency of
          stabilize is measured against the state of instability from effects
          like Scramble
        </p>
        <p>Potency scales with remediation of jamming</p>
      </div>
    </>
  );
};
