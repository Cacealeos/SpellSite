...
export default function DisruptionLimiter({
  ParentMastery,
  active,
}: DisruptionLimiterProps) {
  ...
  const potencyOptions = [
    {
      ...
      label: "Minor",
      description: "Maximum increment: 8 • Maximum strength: 40",
    },
    {
      value: "MAJOR" as const,
      label: "Major",
      description: "Maximum increment: 16 • Maximum strength: 80",
    },
    {
      value: "EXTREME" as const,
      label: "Extreme",
      description: "Maximum increment: 24 • Maximum strength: 120",
    },
  ];
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-gray-400">
              Disruption will be inflicted until a maximum of{" "}
