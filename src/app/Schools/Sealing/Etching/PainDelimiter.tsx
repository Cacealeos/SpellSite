...
export default function PainDeLimiter({
  ParentMastery,
  active,
}: PainDeLimiterProps) {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-lg font-semibold text-gray-100">Pain Delimiter</h1>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-gray-400">
              Inflict Pain until a maximum of{" "}
