...
type PossessMountProps = {
  ParentMastery: Mastery;
  active: boolean;
  updateSpell: <K extends keyof Spell>(field: K, value: Spell[K]) => void;
};

type MountType = "Seal" | "Construct" | "Entity" | "Link" | "Orchestrate";
...
export default function PossessMount({
  ParentMastery,
  active,
  updateSpell,
}: PossessMountProps) {
  const [ppp, setPPP] = useState(0);
  const [type, setType] = useState<MountType>("Seal");
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-lg font-semibold text-gray-200">Possession Mount</h1>
